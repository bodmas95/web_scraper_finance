...
# ---------------------------------------------------------------------------
# Extract labels from ixbrlviewer.html script tag
# ---------------------------------------------------------------------------
...
def extract_labels_from_ixbrl_viewer(html_content: str) -> Dict[str, Tuple[str, str]]:
    ...
    for script in scripts:
        ...
        try:
            ...
            continue
        try:
            concepts = data['sourceReports'][0]['targetReports'][0]['concepts']
...
# These are FALLBACK labels; prefer labels from ixbrlviewer.html when available.
# ---------------------------------------------------------------------------
...
IFRS_CONCEPT_LABELS: Dict[str, Tuple[str, str]] = {
    ...
    "MiscellaneousOtherOperatingIncome":
        ("Autres recettes d'exploitation diverses", "Miscellaneous other operating income"),
    "MiscellaneousOtherOperatingExpense":
        ("Autres charges d'exploitation diverses", "Miscellaneous other operating expense"),
    "CostOfSales":
    ...
    "EmployeeBenefitsExpense":
        ("Charges au titre des avantages du personnel", "Employee benefits expense"),
    "DepreciationAmortisationAndImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss":
        ("Dépréciation, amortissement et perte de valeur (reprise de perte de valeur) comptabilisés en résultat", "Depreciation, amortisation and impairment loss recognised in profit or loss"),
    ...
    "ProfitLossFromOperatingActivities":
        ("Profits (pertes) d'activités opérationnelles", "Profit (loss) from operating activities"),
    "ProfitLossBeforeTax":
        ("Résultat avant impôt", "Profit (loss) before tax"),
    "FinanceCosts":
        ("Charges financières", "Finance costs"),
    "FinanceIncome":
        ("Produits financiers", "Finance income"),
    "FinanceIncomeExpense":
        ("Produits financiers (charges financières)", "Finance income (cost)"),
    ...
    "InterestExpense":
        ("Charge d'intérêt", "Interest expense"),
    ...
    "OtherFinanceIncome":
        ("Autres produits financiers", "Other finance income"),
    "OtherFinanceCost":
        ("Autres charges financières", "Other finance cost"),
    "FinanceIncomeCost":
        ("Produits financiers (charges financières)", "Finance income (cost)"),
    "ShareOfProfitLossOfAssociatesAccountedForUsingEquityMethod":
        ("Quote-part dans le résultat des entreprises associées", "Share of profit of associates"),
    "IncomeTaxExpenseContinuingOperations":
        ("Charge (produit) d'impôt", "Tax expense (income)"),
    "ProfitLoss":
    ...
    "BasicEarningsLossPerShare":
        ("Résultat (perte) de base par action", "Basic earnings (loss) per share"),
    "DilutedEarningsLossPerShare":
        ("Résultat (perte) dilué par action", "Diluted earnings (loss) per share"),
    # OCI
    "OtherComprehensiveIncome":
        ("Autres éléments du résultat global", "Other comprehensive income"),
    "OtherComprehensiveIncomeThatWillBeReclassifiedToProfitOrLossNetOfTax":
        ("Autres éléments du résultat global qui seront reclassés en résultat net, nets d'impôt", "Other comprehensive income that will be reclassified to profit or loss, net of tax"),
    "OtherComprehensiveIncomeThatWillNotBeReclassifiedToProfitOrLossNetOfTax":
        ("Autres éléments du résultat global qui ne seront pas reclassés en résultat net, nets d'impôt", "Other comprehensive income that will not be reclassified to profit or loss, net of tax"),
    "OtherComprehensiveIncomeNetOfTaxExchangeDifferencesOnTranslation":
        ("Autres éléments du résultat global, nets d'impôt, écarts de change résultant de la conversion d'activités à l'étranger", "Other comprehensive income, net of tax, exchange differences on translation"),
    "OtherComprehensiveIncomeBeforeTaxGainsLossesOnRemeasurementsOfDefinedBenefitPlans":
        ("Autres éléments du résultat global, avant impôt, profits (pertes) résultant de réévaluations au titre des régimes à prestations définies", "Other comprehensive income, before tax, gains (losses) on remeasurements of defined benefit plans"),
    "IncomeTaxRelatingToComponentsOfOtherComprehensiveIncomeThatWillBeReclassifiedToProfitOrLoss":
        ("Impôt sur le résultat en relation avec des composantes des autres éléments du résultat global qui seront reclassées en résultat net", "Income tax relating to components of OCI that will be reclassified to profit or loss"),
    "IncomeTaxRelatingToComponentsOfOtherComprehensiveIncomeThatWillNotBeReclassifiedToProfitOrLoss":
        ("Impôt sur le résultat en relation avec des composantes des autres éléments du résultat global qui ne seront pas reclassées en résultat net", "Income tax relating to components of OCI that will not be reclassified to profit or loss"),
    "ComprehensiveIncome":
        ("Résultat global", "Comprehensive income"),
    # OVH-specific income statement concepts
    "OperatingExpensesOtherThanPersonnelExpenses":
        ("Charges opérationnelles (autres que charges de personnel)", "Operating expenses (other than personnel expenses)"),
    "CurrentEbitda":
        ("EBITDA courant", "Current EBITDA"),
    "CurrentOperatingIncome":
        ("Résultat opérationnel courant", "Current operating income"),
    "RevaluationOfHedgingInstruments":
    ...
    "IntangibleAssetsOtherThanGoodwill":
        ("Immobilisations incorporelles autres que le goodwill", "Intangible assets other than goodwill"),
    ...
    "DeferredTaxAssets":
        ("Actifs d'impôt différé", "Deferred tax assets"),
    "NoncurrentFinancialAssets":
        ("Autres actifs financiers non courants", "Other non-current financial assets"),
    "OtherNoncurrentFinancialAssets":
        ("Autres actifs financiers non courants", "Other non-current financial assets"),
    "NoncurrentDerivativeFinancialAssets":
        ("Actifs financiers dérivés non courants", "Non-current derivative financial assets"),
    ...
    "CurrentTradesReceivablesAndContractAssets":
        ("Clients et actifs sur contrats courants", "Current trades receivables and contract assets"),
    "CurrentTaxAssets":
        ("Actifs d'impôt exigible, courants", "Current tax assets"),
    "CurrentTaxAssetsCurrent":
        ("Actifs d'impôt exigible, courants", "Current tax assets, current"),
    "CurrentFinancialAssets":
        ("Actifs financiers courants", "Current financial assets"),
    "CurrentDerivativeFinancialAssets":
        ("Actifs financiers dérivés courants", "Current derivative financial assets"),
    "OtherCurrentAssets":
    ...
    "RetainedEarningsProfitLossForReportingPeriod":
        ("Résultats non distribués, profit (perte) pour la période de reporting", "Retained earnings, profit (loss) for reporting period"),
    "OtherReserves":
    ...
    "NoncurrentBorrowings":
        ("Partie non courante d'emprunts non courants", "Non-current borrowings"),
    "LongtermBorrowings":
        ("Partie non courante d'emprunts non courants", "Non-current portion of non-current borrowings"),
    "NoncurrentLeaseLiabilities":
        ("Passifs au titre de contrats de location non courants", "Non-current lease liabilities"),
    "DeferredTaxLiabilities":
        ("Passifs d'impôt différé", "Deferred tax liabilities"),
    ...
    "NoncurrentDerivativeFinancialLiabilities":
        ("Passifs financiers dérivés non courants", "Non-current derivative financial liabilities"),
    "CurrentBorrowings":
        ("Emprunts courants et partie courante d'emprunts non courants", "Current borrowings"),
    "CurrentBorrowingsAndCurrentPortionOfNoncurrentBorrowings":
        ("Emprunts courants et partie courante d'emprunts non courants", "Current borrowings and current portion of non-current borrowings"),
    "CurrentLeaseLiabilities":
        ("Passifs au titre de contrats de location courants", "Current lease liabilities"),
    "CurrentProvisions":
    ...
    "TradeAndOtherCurrentPayablesToTradeSuppliers":
        ("Dettes fournisseurs courantes", "Current trade payables"),
    "TradePayables":
        ("Fournisseurs", "Trade payables"),
    "CurrentTaxLiabilities":
        ("Passifs d'impôt exigible, courants", "Current tax liabilities"),
    "CurrentTaxLiabilitiesCurrent":
        ("Passifs d'impôt exigible, courants", "Current tax liabilities, current"),
    "CurrentDerivativeFinancialLiabilities":
        ("Passifs financiers dérivés courants", "Current derivative financial liabilities"),
    ...
    "CashFlowsFromUsedInOperationsBeforeChangesInWorkingCapital":
        ("Capacité d'autofinancement", "Cash flows from (used in) operations before changes in working capital"),
    "CashFlowsFromUsedInInvestingActivities":
        ("Flux de trésorerie résultant (utilisés dans le cadre) d'activités d'investissement", "Cash flows from (used in) investing activities"),
    "CashFlowsFromUsedInFinancingActivities":
        ("Flux de trésorerie résultant (utilisés dans le cadre) d'activités de financement", "Cash flows from (used in) financing activities"),
    "ProfitLossAdjustedForNoncashItems":
        ("Capacité d'autofinancement", "Profit adjusted for non-cash items"),
    "AdjustmentsForDepreciationAndAmortisationExpense":
        ("Ajustements pour dotations aux amortissements", "Adjustments for depreciation and amortisation"),
    "AdjustmentsForDepreciationAndAmortisationExpenseAndImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss":
        ("Ajustements pour dotations aux amortissements et perte de valeur (reprise de perte de valeur) comptabilisée en résultat", "Adjustments for depreciation and amortisation expense and impairment loss recognised in profit or loss"),
    "AdjustmentsForImpairmentLossReversalOfImpairmentLossRecognisedInProfitOrLoss":
        ("Ajustements pour pertes de valeur", "Adjustments for impairment loss"),
    "AdjustmentsForProvisions":
        ("Ajustements pour provisions", "Adjustments for provisions"),
    "AdjustmentsForIncomeTaxExpense":
        ("Ajustements pour charge d'impôt sur le résultat", "Adjustments for income tax expense"),
    "AdjustmentsForFinanceCosts":
        ("Ajustements pour coût de l'endettement", "Adjustments for finance costs"),
    "AdjustmentsForSharebasedPayments":
        ("Ajustements pour paiements fondés sur des actions", "Adjustments for share-based payments"),
    "AdjustmentsForGainsLossesOnDisposalOfNoncurrentAssets":
        ("Ajustements pour pertes (profits) dégagé(e)s sur la sortie d'actifs non courants", "Adjustments for losses (gains) on disposal of non-current assets"),
    "AdjustmentsForLossesGainsOnDisposalOfNoncurrentAssets":
        ("Ajustements pour pertes (profits) dégagé(e)s sur la sortie d'actifs non courants", "Adjustments for losses (gains) on disposal of non-current assets"),
    "IncreaseDecreaseInWorkingCapital":
        ("Augmentation (diminution) du fonds de roulement", "Increase (decrease) in working capital"),
    "IncreaseDecreaseInTradeAndOtherPayables":
        ("Ajustements pour augmentation (diminution) de fournisseurs et autres créditeurs", "Adjustments for increase (decrease) in trade and other payables"),
    "AdjustmentsForIncreaseDecreaseInTradeAndOtherPayables":
        ("Ajustements pour augmentation (diminution) de fournisseurs et autres créditeurs", "Adjustments for increase (decrease) in trade and other payables"),
    "IncreaseDecreaseInTradeAndOtherReceivables":
        ("Ajustements pour diminution (augmentation) de clients et autres débiteurs", "Adjustments for decrease (increase) in trade and other receivables"),
    ...
    "IncomeTaxesPaidRefundClassifiedAsOperatingActivities":
        ("Impôts sur le résultat payés (remboursés), classés dans les activités opérationnelles", "Income taxes paid (refund), classified as operating activities"),
    "InterestPaid":
        ("Intérêts financiers payés", "Interest paid"),
    "InterestPaidClassifiedAsFinancingActivities":
        ("Intérêts payés, classés dans les activités de financement", "Interest paid, classified as financing activities"),
    ...
    "PaymentsRelatedToAcquisitionsOfPropertyPlantAndEquipmentAndIntangibleAssets":
        ("Décaissements liés aux acquisitions d'immobilisations corporelles et incorporelles", "Payments related to acquisitions of PP&E and intangible assets"),
    ...
    "CashInflowsOutflowsRelatedToBusinessCombinationsNetOfCash":
        ("Encaissements/(décaissements) liés aux regroupements d'entreprises nets de leur trésorerie", "Cash inflows/(outflows) related to business combinations net of cash"),
    ...
    "ReceiptsDisbursementsRelatedToLoansAndAdvancesGranted":
        ("Encaissements/(décaissements) liés aux prêts et avances consentis", "Receipts/(disbursements) related to loans and advances granted"),
    "ProceedsFromBorrowingsClassifiedAsFinancingActivities":
        ("Produits d'emprunts, classés dans les activités de financement", "Proceeds from borrowings, classified as financing activities"),
    "RepaymentsOfBorrowingsClassifiedAsFinancingActivities":
        ("Remboursements d'emprunts, classés dans les activités de financement", "Repayments of borrowings, classified as financing activities"),
    ...
    "PaymentsOfLeaseLiabilitiesClassifiedAsFinancingActivities":
        ("Paiements de passifs au titre de contrats de location, classés dans les activités de financement", "Payments of lease liabilities, classified as financing activities"),
    "PaymentsForRepurchaseOfShares":
        ("Rachat d'actions propres", "Payments for repurchase of shares"),
    "PaymentsToAcquireOrRedeemEntitysShares":
        ("Paiements pour acquérir ou racheter les actions de l'entité", "Payments to acquire or redeem entity's shares"),
    ...
    "GuaranteeDepositsReceivedAndOtherFinancialDebt":
        ("Dépôts de garanties reçus et autres dettes financières", "Guarantee deposits received and other financial debts"),
    "EffectOfExchangeRateChangesOnCashAndCashEquivalents":
        ("Effet des variations des taux de change sur la trésorerie et les équivalents de trésorerie", "Effect of exchange rate changes on cash and cash equivalents"),
    "IncreaseDecreaseInCashAndCashEquivalents":
        ("Augmentation (diminution) de la trésorerie et des équivalents de trésorerie après effet des variations des taux de change", "Increase (decrease) in cash and cash equivalents"),
    ...
    "CashAndCashEquivalentsIfDifferentFromStatementOfFinancialPosition":
        ("Trésorerie et équivalents de trésorerie si différents de l'état de la situation financière", "Cash and cash equivalents if different from statement of financial position"),
...
STATEMENT_MAP: Dict[str, str] = {
    ...
    "OtherFinanceIncome":                   "Income Statement",
    "OtherFinanceCost":                     "Income Statement",
    "FinanceIncomeCost":                    "Income Statement",
    "RevaluationOfHedgingInstruments":      "Income Statement",
    "NetFinancialIncomeExpenseExcludingForeignExchangeDifferences": "Income Statement",
    ...
    "CurrentTradesReceivablesAndContractAssets": "Assets",
    ...
    "OtherNoncurrentFinancialLiabilities":  "Liabilities",
    "NoncurrentDerivativeFinancialLiabilities": "Liabilities",
    ...
    "AdjustmentsForDecreaseIncreaseInTradeAndOtherReceivables": "Cash Flow",
    ...
    "CashInflowsOutflowsRelatedToBusinessCombinationsNetOfCash": "Cash Flow",
    "ProceedsFromSaleOfInterestsInAssociates": "Cash Flow",
    "ReceiptsDisbursementsRelatedToLoansAndAdvancesGranted": "Cash Flow",
    ...
    "CashAndCashEquivalentsIfDifferentFromStatementOfFinancialPosition": "Cash Flow",
    "BankOverdraftsClassifiedAsCashEquivalents": "Cash Flow",
}
...
_STATEMENT_ORDER = {
    "Income Statement": [
        ...
        "OperatingExpense", "DistributionCosts", "AdministrativeExpense",
        "SellingGeneralAndAdministrativeExpense", "OtherExpenseByFunction",
...
def _parse_period(period: str):
    ...
    if "/" in period:
        ...
        # If the period ends on Jan 1 (e.g. "2025-01-01T00:00:00"), the actual
        # fiscal year is the prior year (calendar-year companies report Jan 1 → Jan 1).
        end_date = end[:10]  # "YYYY-MM-DD"
        if end_date[5:] == "01-01" and len(end) >= 4:
            fy_year = str(int(end[:4]) - 1)
        else:
...
def _fmt_number(n: float) -> str:
    """Format a number removing unnecessary trailing zeros after decimal point."""
    if n == int(n):
        return f"{int(n):,}"
    return f"{n:,.1f}"
...
def get_value_unit_label(decimals) -> str:
...
def build_filing_view(
    ...
    A filing typically contains comparative data for two years (current + one prior).
    Only the two most recent fiscal years (from duration facts) are shown — this
    ...
    duration_years = sorted(
        {f["fy_year"] for f in facts if f.get("fy_year") and f.get("period_type") == "duration"},
        reverse=True,
    )
    # Take at most 2 most recent years; fall back to instant years if no duration facts
    if duration_years:
        keep_years = set(duration_years[:2])
    else:
        all_years = sorted(
            {f["fy_year"] for f in facts if f.get("fy_year")},
            reverse=True,
        )
        keep_years = set(all_years[:2])

    # Group facts by fy_year, filtering to keep_years only (drop UNKNOWN and extras)
    all_facts_by_fy: Dict[str, List[dict]] = {}
    for fact in facts:
        fy_year = fact.get("fy_year", "")
        if fy_year not in keep_years:
            continue
        fy_lbl = f"FY{fy_year}"
